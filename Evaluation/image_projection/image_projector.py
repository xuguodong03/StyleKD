...
def Image_Projector(generator, device, per_layer_W, target_im, opt, num_iters=500, print_iters=20, criterion=None, return_z=False):
    '''
    Usage:
    ...
    if return_z:
        return (input_img, output_img, input_kwargs)
    else:
