...
def Get_Model_FID_Score(generator, load_inception_net = True, device = 'cuda', gpu_device_ids = None,
    ...
    if img_size == 256:
        ...
        if osp.exists('Evaluation/church.pkl'):
            features = extract_feature_from_images(generator, inception, truncation, mean_latent, 
                                        batch_size, num_sample, device, loader, info_print).numpy()
