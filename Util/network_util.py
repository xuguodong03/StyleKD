...
def Build_Generator_From_Dict(model_dict, size=256, latent=512, n_mlp=8, load=True, lr_mlp=0.01, kernel_size=3):
    '''
    Usage:
    ...
    generator = Generator(size, latent, n_mlp, generator_net_shape=net_shape, lr_mlp=lr_mlp, kernel_size=kernel_size)
    if load:
